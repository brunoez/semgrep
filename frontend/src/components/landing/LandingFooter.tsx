        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="flex items-center gap-1 text-[10px] font-mono font-semibold px-2 py-0.5 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 shadow-sm" title="v{version}">
                <Tag className="w-3 h-3 text-indigo-400" /> v{version}
              </span>
            </div>
            <p className="text-slate-500 mt-0.5">{t('footerSubtitle')}</p>
          </div>
        </div>

        <div className="flex items-center gap-6 text-slate-400 font-mono text-[11px] flex-wrap justify-center md:justify-start">
          ...
          <a
            href="https://github.com/brunoez/semgrep"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 hover:text-white transition text-slate-300"
          >
            <Github className="w-3.5 h-3.5 text-indigo-400" /> {t('footerProjectGithub')}
          </a>
          <a
          ...
          >
            <Github className="w-3.5 h-3.5" /> {t('footerSemgrepGithub')}
          </a>
        </div>

        <div className="text-slate-500 text-right">
          <p>© {new Date().getFullYear()} {t('footerCopyright')}</p>
          <p className="text-[10px] text-slate-600 mt-0.5">{t('footerSecurityNote')}</p>
        </div>
      </div>
    </footer>
  );
